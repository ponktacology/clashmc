...
public class CobbleXSubMenu extends SubMenu {
  ...
  public String getTitle(Player player) {
    return DropType.COBBLEX.getMenuTitle();
  }
  ...
  public Map<Integer, Button> getButtons(Player player) {
    ...
    for (DropItem dropItem : this.dropItemCache.values(DropType.COBBLEX)) {
      buttons.put(
          dropItem.getIndex(), new DropItemButton(dropItem, this.playerCache, this.taskDispatcher));
    }
