...
package me.ponktacology.clashmc.core.util.reflection;
...
public final class Reflection {
    ...
    public static final FieldAccessor<Integer> getPing = Reflection.getField("{nms}.EntityPlayer", "ping", int.class);
    private Reflection() {
        // Seal class
    }
    ...
    public static <T> FieldAccessor<T> getFieldSafe( String className,  Class<T> fieldType, int index) {
        try {
            ...
            log.info("[WARN] Failed to find field at " + index + " in " + className + " with type " + fieldType.getSimpleName());
            return null;
        }
    }
